...
export async function POST(request: NextRequest) {
  ...
  const preconisation = await prisma.preconisation.create({
    data: {
      ...
      dureeValeur: dureeValeur != null && dureeValeur !== "" ? Number(dureeValeur) : null,
      dureeUnite: dureeUnite?.trim() || null,
      nombreAdministrations: nombreAdministrations != null && nombreAdministrations !== "" ? Number(nombreAdministrations) : null,
